...
struct protocol_packet unpack(char *, ssize_t);
struct protocol_packet create_packet(void);
struct protocol_packet create_single_packet(uint8_t, char *);
struct protocol_packet create_double_packet(uint8_t, char *, char *);
